...
if not exist bin PowerShell -Command^ "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Le dossier 'bin' est introuvable. Vous pouvez le trouver ici: https://github.com/NelibYT/ytMP4/releases', 'ytMP4', 'OK', [System.Windows.Forms.MessageBoxIcon]::Warning)}" & exit
...
del bin\url.tmp & del bin\ttl.tmp
...
if %vc%==1 PowerShell -Command^ "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Une erreur est survenue. Verifiez l'URL ou votre connexion puis reessayez.', 'ytMP4', 'OK', [System.Windows.Forms.MessageBoxIcon]::Warning)}"
